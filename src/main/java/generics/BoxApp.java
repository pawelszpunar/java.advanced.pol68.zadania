...
public class BoxApp {
    public static void main(String[] args) {
        ...
        System.out.println(personBox.getContent());
        //do pudełka na obiekty typu interfejsu możemy dodawać dowolne obiekty implementujjące ten interfejs
        Box<Boxable> universalBox = new Box<>(new User("robert", 165.5, "aa@aa.pl"),87);
